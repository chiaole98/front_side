...
<html lang="en">
  ...
  <body>
        ...
        <nav class="menu navbar">
          <div class="icon-list navbar-collapse">
            <ul class="navbar-nav">
              ...
              <li class="nav-item">
                <a class="nav-link" href="#subscription">訂閱內容</a>
              </li>  
              <li class="nav-item">
                <a class="nav-link" href="#favorite">我的收藏</a>
              </li>                            
              <li class="nav-item">
                <a class="nav-link" href="#historical">我的紀錄</a>
              </li>            
              <li class="nav-item">
                <a class="nav-link" href="#myaccount">我的帳號</a>
              </li> 
                <li class="nav-item">
    ...
    <section id="news" class="section">
      <div class="card-body">
        <div class="section-header">          
          <h2 class="section-title wow fadeIn" data-wow-duration="1000ms" data-wow-delay="0.3s">最新<span>消息</span></h2>
    ...
    <section id="subscription" class="section">
      <div class="card-body">
        <div class="section-header">          
          <h2 class="section-title wow fadeIn" data-wow-duration="1000ms" data-wow-delay="0.3s">我的<span>訂閱內容</span></h2>
          <hr class="lines wow zoomIn" data-wow-delay="0.3s">
        </div>
        <div class="row">
          <div class="col-md-4 col-sm-6">
    ...
    <section id="favorite" class="section" data-stellar-background-ratio="0.2">
      <div class="card-body">
        <div class="section-header">          
          <h2 class="section-title wow fadeIn" data-wow-duration="1000ms" data-wow-delay="0.3s">我的 <span>收藏</span></h2>
          <hr class="lines wow zoomIn" data-wow-delay="0.3s">
        </div>
        <div class="row">
