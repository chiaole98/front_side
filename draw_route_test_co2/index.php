...
<head>
    ...
    <script defer
            src="https://maps.googleapis.com/maps/api/js?libraries=places&language=<?= $_SESSION['lang'] ?>&key=AIzaSyA6REIyT-DGTTM1bdJvkNn4SfKd3t7gUcA"
...
<div class="container">
        ...
        <form method='get' action='' id='form_lang'>
            ...
            Select Language : <select class="form-control" name='lang' onchange='changeLang();'>
                ...
                <option value='cn' <?php if (isset($_SESSION['lang']) && $_SESSION['lang'] == 'cn') {
                    echo "selected";
                } ?> >Chinese
                </option>
        ...
        <div class="col-sm-4">
            ...
            <form id="distance_form">
                ...
                <div class="form-group"><label><?= $lang['origin'] ?>: </label>
                    ...
                    <a class="form-control" onclick="getCurrentPosition()">使用目前位置</a>
                </div>
        ...
        <div class="col-sm-4">
            <div style="margin-left: 123px;" id="result" class="hide">
                <ul class="list-group">
                    ...
                    <br>
                    <br>
                    <li id="cal_co2" class="list-group-item d-flex justify-content-between align-items-center"></li> <br>
                    <br>
...
<script>
    $(function () {
        ...
        function save_results(response, status) {
            ...
            if (status != google.maps.DistanceMatrixStatus.OK) {
                ...
                if (response.rows[0].elements[0].status === "ZERO_RESULTS") {
                    ...
                    var calculate_co2 = distance.value / 1000 * 0.235; // co2
                    var duration_text = duration.text;
                    appendResults(distance_in_kilo, calculate_co2, duration_text);
                    sendAjaxRequest(origin, destination, distance_in_kilo, calculate_co2, duration_text);
                }
            }
        }

        // append html results
        function appendResults(distance_in_kilo, calculate_co2, duration_text) {
            $("#result").removeClass("hide");
            $('#cal_co2').html("<?= $lang['calculate_co2'] ?> : <span class='badge badge-pill badge-secondary'>" + calculate_co2.toFixed(2) +"( gCO2e )"+ "</span>");
        ...
        function sendAjaxRequest(origin, destination, distance_in_kilo, calculate_co2, duration_text) {
